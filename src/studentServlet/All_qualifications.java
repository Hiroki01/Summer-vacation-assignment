...
/**
 * Servlet implementation class All_qualifications
 */
@WebServlet("/All_qualifications")
public class All_qualifications extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public All_qualifications() {
        super();
	...
	protected void doGet(HttpServletRequest re, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ArrayList<StudentQualificationDTO> result = StudentQualificationDAO.searchid(id);
